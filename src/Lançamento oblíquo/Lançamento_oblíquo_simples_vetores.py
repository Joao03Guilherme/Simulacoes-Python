...
class ball:
    def __init__(self, mass, radius, initial_position, initial_velocity, initial_acceleration):
        ...
        self.vpython_obj_velocity = arrow(pos=initial_position, axis=initial_velocity.norm(), length=initial_velocity.mag/5)
    ...
    def update_position(self, dt):
        ...
        self.vpython_obj_velocity.pos = self.position
        self.vpython_obj_velocity.axis = self.velocity.norm()
        self.vpython_obj_velocity.length = self.velocity.mag/4
